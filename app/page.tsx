...
export default async function Home() {
  ...
  const { docs: characterHome } = { docs: listCharacter }
  const { docs: productHome } = { docs: listProduct }
    ...
    <MainLayout>
      <main className="w-[1280px] mt-[100px] text-black mx-auto">
        ...
        <nav className="w-full grid grid-cols-3 mb-8 bg-white p-4 h-max gap-4 overflow-hidden rounded-md">
          <Image className="w-full h-[180px] object-cover rounded-md cursor-pointer" src={require("@/public/images/banner_1.jpg").default} alt="" />
          <Image className="w-full h-[180px] object-cover rounded-md cursor-pointer" src={require("@/public/images/banner_2.jpg").default} alt="" />
          <Image className="w-full h-[180px] object-cover rounded-md cursor-pointer" src={require("@/public/images/banner_3.jpg").default} alt="" />
        </nav>
        {/* Figure */}
        <div className="w-full  grid grid-cols-10 bg-white p-4 h-[170px]  overflow-hidden rounded-md">
          {characterHome?.map((item: ICharacter, index: number) => (
            <Link href={`collections/characters/${item.character_id}`} key={index}>
        ...
        <ul className="w-full grid grid-cols-4  bg-white p-4 h-max my-8 gap-4 overflow-hidden rounded-md">
          <li className="w-full h-[220px] overflow-hidden object-cover rounded-md cursor-pointer">
            <Image className="w-full h-full hover:scale-110 transition-all duration-500" src={require("@/public/images/FeaturedProducts.png").default} alt="" /></li>
          <li className="w-full h-[220px] overflow-hidden object-cover rounded-md cursor-pointer">
            <Image className="w-full h-full hover:scale-110 transition-all duration-500" src={require("@/public/images/BestMonth.png").default} alt="" /></li>
          <li className="w-full h-[220px] overflow-hidden object-cover rounded-md cursor-pointer">
            <Image className="w-full h-full hover:scale-110 transition-all duration-500" src={require("@/public/images/ScaleProduct.png").default} alt="" /></li>
          <li className="w-full h-[220px] overflow-hidden object-cover rounded-md cursor-pointer">
            <Image className="w-full h-full hover:scale-110 transition-all duration-500" src={require("@/public/images/HotDeal.png").default} alt="" /></li>
        </ul>
