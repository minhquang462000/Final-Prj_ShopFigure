...
export default function CardInfoItem (props: ICardInfoItemProps) {
  return (
    <div className="col-span-1  bg-white pb-8  rounded-md p-3">
            <ul className="flex flex-col  rounded-t-lg border pb-4 gap-3">
              <li className="flex w-full bg-[#38bf57] py-2 px-3 text-white font-bold">
                {" "}
                Cam kết bán hàng
              </li>
            ...
            <ul className="flex flex-col mt-4  rounded-t-lg border pb-4 gap-3">
              <li className="flex w-full bg-[#38bf57] py-2 px-3 text-white font-bold">
                {" "}
                Lưu ý khi mua hàng
              </li>
              <li className="flex  w-full px-3 gap-2">
                {" "}
