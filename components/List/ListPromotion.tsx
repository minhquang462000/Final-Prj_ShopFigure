...
export default function ListPromotion (props: IListPromotionProps) {
  return (
    <tr className='text-xs grid grid-cols-1 grid-rows-10 w-full mb-4   gap-3'>
      <td className='w-full flex col-span-1  min-h-[70px] overflow-hidden gap-2'>
       ...
       <h1 className='text-sm text-w line-clamp-2 cursor-pointer  '>Tiêu đề bài Post abc abc bac bidklfjdkfjsdklmf sdokhjfsd odkfjsd kjdfkl kljsdfkl kljsdfklj sdflkjsd sdfklfjds kjfdkll sdkfjds</h1>
