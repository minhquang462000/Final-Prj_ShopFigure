  ...
  return (
    <div className='grid grid-cols-2 mb-4 gap-4'>
      <div className='w-full flex flex-col font-extralight  gap-3'>
        ...
        <h3 className='text-xl line-clamp-2  cursor-pointer font-medium'>Tiêu đề bài Post abc abc bac bidklfjdkfjsdklmf sdokhjfsd odkfjsd kjdfkl kljsdfkl kljsdfklj sdflkjsd sdfklfjds kjfdkll sdkfjds</h3>
      ...
      <ul className='text-xs flex mt-1 flex-col gap-3'>
      <li className='w-full flex  gap-2'>
       ...
       <h3 className='text-sm line-clamp-2 cursor-pointer font-medium'>Tiêu đề bài Post abc abc bac bidklfjdkfjsdklmf sdokhjfsd odkfjsd kjdfkl kljsdfkl kljsdfklj sdflkjsd sdfklfjds kjfdkll sdkfjds</h3>
